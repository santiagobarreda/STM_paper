...
mtext (side=3,"Predicting Perceived Category",line=0.2)
...
mtext (side=3,"Predicting Intended Category",line=0.2)
...
mtext(side = 3, expression(Predicting ~ psi[s]), line = 0.2)
