...
A second reason as to why the PSTM has not received more attention might originate in the less than striking *result* presented in @NA07. As we show below, these results were caused by a problematic choice Nearey and Assman made during the evaluation of the PSTM against listeners' perception. Once this issue is addressed, we find that the incremental inference procedure proposed for the PSTM explains listeners' perception very well, and *substantially* better than the most frequently used normalization account (Lobanov). 
